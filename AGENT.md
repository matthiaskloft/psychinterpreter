...
**Purpose**: Quick reference for a generic agent when helping users with the **psychinterpreter** R package.
...
- **AGENT.md** (this file): General usage guide for all agents.
- **CLAUDE.md**: Model-specific guidance for Claude.
- **GEMINI.md**: Model-specific guidance for Gemini.
...
For details on configuring specific models, API keys, and any model-specific parameters, please refer to the following documents:
...
Update this file when making **general, user-facing changes**:
- New user-facing functions or parameters applicable to all models
- Changes to general usage patterns or workflows
...
## When to Update CLAUDE.md / GEMINI.md

Update the model-specific files when making changes that only apply to one model:
- API key setup or changes
- Model-specific parameters or functions
- Provider-specific troubleshooting

**When completing TODOs**:
1. Remove from "Active TODOs" section in AGENT.md
2. Update "Last Updated" date in all relevant files
...
1. **Clear separation**: AGENT.md = general guide, CLAUDE.md/GEMINI.md = specific guides, DEV GUIDE = technical reference
