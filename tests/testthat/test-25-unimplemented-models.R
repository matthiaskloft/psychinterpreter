# Test handling of unimplemented model types (IRT, CDM)
# These model types are planned but not yet implemented
# Note: GM was previously tested here but is now implemented
...
test_that("Error messages for unimplemented types are informative", {
  ...
  # GM is now implemented, so test with IRT instead
  ...
  # Check that error message mentions what is supported or that it's not implemented
  expect_true(
    grepl("fa|factor analysis|gm|gaussian mixture", error_msg, ignore.case = TRUE) ||
