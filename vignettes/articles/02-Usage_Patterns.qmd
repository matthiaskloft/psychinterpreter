...
We use Ollama, so we need to make sure the Ollama server is running before executing this document.

::: {.callout-note}
**Starting Ollama**

Make sure Ollama is running before rendering this document. You can start it with:
```bash
ollama serve
```
:::
